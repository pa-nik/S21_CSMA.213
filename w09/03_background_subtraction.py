# Background Subtraction example from Artificial Intelligence with Python:
# https://github.com/PacktPublishing/Artificial-Intelligence-with-Python-Second-Edition/blob/master/Chapter18/background_subtraction.py
